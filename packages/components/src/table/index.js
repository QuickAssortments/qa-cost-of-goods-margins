				...
				action={ [
					compareBy && (
						<CompareButton
							...
							helpText={
								labels.helpText || __( 'Check at least two items below to compare', 'qa-cost-of-goods-margins' )
							}
							onClick={ this.onCompare }
							disabled={ ! hasData }
						>
							{ labels.compareButton || __( 'Compare', 'qa-cost-of-goods-margins' ) }
						</CompareButton>
					),
					searchBy && (
						<Search
							...
							placeholder={ labels.placeholder || __( 'Search by item name', 'qa-cost-of-goods-margins' ) }
					...
					( downloadable || onClickDownload ) && (
						...
						>
							...
							<span className="woocommerce-table__download-button__label">
								{ labels.downloadButton || __( 'Download', 'qa-cost-of-goods-margins' ) }
							</span>
						</IconButton>
					),
				] }
				menu={
					showMenu && <EllipsisMenu label={ __( 'Choose which values to display', 'qa-cost-of-goods-margins' ) }
						renderContent={ () => (
							<Fragment>
								<MenuTitle>{ __( 'Columns:', 'qa-cost-of-goods-margins' ) }</MenuTitle>
				...
				{ isLoading ? (
					<Fragment>
						<span className="screen-reader-text">
							{ __( 'Your requested data is loading', 'qa-cost-of-goods-margins' ) }
						</span>
						<TablePlaceholder
