...
class NumberFilter extends Component {
	...
	getFilterInputs() {
		...
		if ( 'lessthan' === filter.rule ) {
			...
			labelFormat = _x( '%(field)s maximum amount', 'maximum value input', 'qa-cost-of-goods-margins' );
		} else {
			/* eslint-disable-next-line max-len */
			...
			labelFormat = _x( '%(field)s minimum amount', 'minimum value input', 'qa-cost-of-goods-margins' );
		}
			...
			components: {
				rangeStart: this.getFormControl( {
					...
					label: sprintf(
						...
						__( '%(field)s range start', 'qa-cost-of-goods-margins' ),
				...
				rangeEnd: this.getFormControl( {
					...
					label: sprintf(
						...
						__( '%(field)s range end', 'qa-cost-of-goods-margins' ),
						{ field: get( config, [ 'labels', 'add' ] ) }
					),
