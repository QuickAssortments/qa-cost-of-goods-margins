		...
		return (
			<div className="woocommerce-pagination__page-arrows">
				<span
					...
					aria-live="polite"
				>
					{ sprintf( __( 'Page %d of %d', 'qa-cost-of-goods-margins' ), page, this.pageCount ) }
				</span>
				<div className="woocommerce-pagination__page-arrows-buttons">
					<IconButton
						...
						label={ __( 'Previous Page', 'qa-cost-of-goods-margins' ) }
						size={ 18 }
					/>
					<IconButton
						...
						label={ __( 'Next Page', 'qa-cost-of-goods-margins' ) }
						size={ 18 }
					/>
				</div>
			</div>
		...
		return (
			<div className="woocommerce-pagination__page-picker">
				<label htmlFor={ instanceId } className="woocommerce-pagination__page-picker-label">
					{ __( 'Go to page', 'qa-cost-of-goods-margins' ) }
					<input
						id={ instanceId }
	...
	renderPerPagePicker() {
		...
		return (
			<div className="woocommerce-pagination__per-page-picker">
				<SelectControl
					label={ __( 'Rows per page', 'qa-cost-of-goods-margins' ) }
