...
const shortDateFormat = __( 'MM/DD/YYYY', 'qa-cost-of-goods-margins' );
...
class DateRangeFilterPicker extends Component {
	...
	getButtonLabel() {
		...
		return [
			...
			`${ __( 'vs.', 'qa-cost-of-goods-margins' ) } ${ secondary.label } (${ secondary.range })`,
		];
	}
	...
	render() {
		...
		return (
			<div className="woocommerce-filters-filter">
				<span className="woocommerce-filters-label">{ __( 'Date Range', 'qa-cost-of-goods-margins' ) }:</span>
				<Dropdown
