...
class Chart extends Component {
	...
	renderIntervalSelector() {
		...
		const intervalLabels = {
			hour: __( 'By hour', 'qa-cost-of-goods-margins' ),
			day: __( 'By day', 'qa-cost-of-goods-margins' ),
			week: __( 'By week', 'qa-cost-of-goods-margins' ),
			month: __( 'By month', 'qa-cost-of-goods-margins' ),
			quarter: __( 'By quarter', 'qa-cost-of-goods-margins' ),
			year: __( 'By year', 'qa-cost-of-goods-margins' ),
		};
					...
					<div className="woocommerce-chart__header">
						...
						>
							<IconButton
								...
								title={ __( 'Line chart', 'qa-cost-of-goods-margins' ) }
							...
							<IconButton
								...
								title={ __( 'Bar chart', 'qa-cost-of-goods-margins' ) }
